...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('permissions', [
      ...
      { key: 'USER:DELTE', description: "حذف کردن و بن کردن کاربران" , created_at: new Date() , updated_at: new Date()},
      ...
      { key: 'CONTACT:INNSERT', description:"فرستادن پاسخ برای پیغام های کابران", created_at: new Date() , updated_at: new Date()},
