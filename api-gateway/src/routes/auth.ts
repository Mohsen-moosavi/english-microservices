...
import { getCaptchaSchema, resendOtpSchema, sendOtpSchema, verifyOtpSchema } from "@english/contracts";
...
router.post("/verify-code" ,validate(verifyOtpSchema), forwardToIdentityService("/auth/verify-code"))
